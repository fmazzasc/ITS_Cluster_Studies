...
h_kaon_dedx = ROOT.TH2F('h_kaon_dedx', 'h_kaon_dedx',100, 0, 2, 100, 30, 500)
...
df_proton = df.query('abs(nSigmaP)<1 and tpcITSchi2<1')
...
fill_hist_2d(h_kaon_dedx, df_kaon,'p', 'dedx')
